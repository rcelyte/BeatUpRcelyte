...
static partial class BeatUpClient {
	class Downloader { // TODO: implement IDisposable + cancel in Dispose()
		static class BitOperations {
			static (byte first, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte,byte, byte,byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte, byte) DeBruijn =
			...
			public static byte TrailingZeroCount(ulong value) =>
				System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref DeBruijn.first, (System.IntPtr)((value & (ulong)-(long)value) * 0x022fdd63cc95386dLU >> 58));
		}
