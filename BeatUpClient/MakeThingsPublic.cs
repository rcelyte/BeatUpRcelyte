...
var refs = new (string? path, string name, string[]? overrides)[] {
	(managed, "BGNetCore.dll", new[] {
		"ConnectedPlayerManager`3::AddPlayer",
		"ConnectedPlayerManager`3::kMaxUnreliableMessageLength",
		"ConnectedPlayerManager`3::RemovePlayer",
		"ConnectedPlayerManager`3::Write",
		"ConnectedPlayerManager`3::WriteOne",
	...
	(managed, "BeatSaber.Multiplayer.Core.dll", new[] {
		...
		"BGNet.Core.GameLift.GameLiftPlayerSessionProvider::_networkConfig",
	...
	(managed, "Networking.dll", new[] {
		...
		"NetworkConfigSO::_graphAppId",
		"NetworkConfigSO::_graphUrl",
		"NetworkConfigSO::_localServerPort",
		...
		"NetworkConfigSO::_useLocalServer",
	}),
	(managed, "PlatformUserModel.dll", new[] {
		"PlatformAuthenticationTokenProvider::_platformType",
